...
public class Roadvocate {
	 ...
	 private WebDriver driver;
	    ...
	    public void testAddAdvocateonRO() throws InterruptedException {
	        ...
	        advocateNameField.sendKeys("vinay");
...
@Test(priority=2)
public void testApprovalProcessofRO1() throws InterruptedException {
    driver.get("https://safallitigation.onlinesafe.in/");
